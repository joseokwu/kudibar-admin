import { ActionModalSupport, StatusTag } from "../componentHelpers/Tags/Tags.component";
              ...
              <tr key={i}>
                ...
                <td>
                  <StatusTag
                    text={priority}
                    bg={
                      priority === "urgent" ? "#39BD78" : priority === "low" ? "#D34646" : "#E9A420"
                    }
                  />
                </td>
                <td>
                  <StatusBar
                    bg={
                      status === "Pending" ? "#E9A420" : status === "Open" ? "#39BD78" : "#D34646"
                    }
                  >
                    <p>{status}</p>
                  </StatusBar>
                ...
                <td>
                  <div className="relative">
                    <ActionModalSupport id={i} link={"/support/details/id"} />
                  </div>
                </td>
              </tr>
            );
