...
export const TrashModal = ({ closeModal }) => {
  return (
    <Modal closeModal={closeModal}>
      <div style={{ width: "400px" }}>
        <h1 className="text-[24px] mb-[1rem]  font-[700]">Trash Event</h1>
        <form>
          <section className="w-full">
            <label
              htmlFor="reason for flag"
              className="my-4  text-[14px] font-[400]"
            >
              Reason for Trashing Event <span style={{ color: "red" }}>*</span>{" "}
              -
