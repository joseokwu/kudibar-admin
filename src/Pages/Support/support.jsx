    ...
    <div>
      ...
      <WhiteCard>
        <div className="flex flex-row items-center justify-between mb-6">
          ...
          <button className={styles.seeMore} onClick={() => navigate("/support/all-tickets")}>
            See More
          </button>
        </div>
...
export const RecentActivityBar = () => {
  return (
    <div className="bg-[#f5f5f5] rounded-2xl flex flex-row items-center gap-4 pl-8 py-[26px]">
      ...
      <div>
        <p className="mb-2 text-[#121528] text-base" style={{ lineHeight: "22px" }}>
          Curtis submitted a new ticket, Lorem ipsum doloret, amet, consectetur adipiscifacliqsis
          (2337)
        </p>
        <p
