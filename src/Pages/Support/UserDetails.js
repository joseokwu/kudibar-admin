        ...
        <div className="flex flex-start">
          <div className="shadow-[0px 4px 20px rgba(27, 117, 188, 0.04)] rounded-[16px] p-[3rem] my-5 mx-3 bg-[#fff]">
            <div className="flex p-4 items-center justify-center flex-col">
              ...
              <p className="mt-[1.2rem] text-[20px] font-semibold">
                Obodo Bright
              </p>
            </div>
            <hr className="my-3" />
          ...
          <div className="my-5 mx-3">
            <div className="w-full p-[2rem] mb-4 shadow-[0px 4px 20px rgba(27, 117, 188, 0.04)] rounded-[16px] bg-[#fff]">
              <div>
                <h3 className="font-[600] text-[18px] py-[10px]">
                  User Statistics{" "}
                </h3>
              </div>
              <div className=" grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="font[600] text-[32px] text-[#000000] ">
                    3
                  </span>
                </div>
                <div
                  ...
                  return (
                    ...
                    >
                      <div className="flex gap-[12px] items-center">
                        ...
                        <div>
                          <h3>{title}</h3>
                          <span className="text-[#12152899] font-[300] text-[14px]">
                            {date}
                          </span>
                        </div>
                      </div>
