...
const ViewTicket = () => {
  return (
    <div>
      <GoBackTop>
        <div className={`flex flex-row items-center gap-8 ${styles.btnContainer}`}>
    ...
    <div className="bg-[#f5f5f5] rounded-2xl pl-8 pr-6 py-[26px]">
      <div className="grid grid-cols-[52px_1fr] items-center gap-9 mb-6">
        ...
        >
          ...
          <p className="text-base text-[rgb(18, 21, 40)]" style={{ lineHeight: "22px" }}>
            Mar 9, 2021
          </p>
        </div>
      </div>
      ...
      >
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tellus viverra habitasse nibh
        habitasse facilisis nunc amet, urna. Vel lectus ipsum leo. Lorem ipsum dolor sit amet,
        consectetur adipiscing elit. Tellus viverra habitasse nibh habitasse facilisis nunc amet,
        urna. Vel lectus ipsum leo.
      </p>
    </div>
  );
};
